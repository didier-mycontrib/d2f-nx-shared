...
import { FieldHelper } from '../../common/helper/field-helper';
...
@Component({
  ...
  imports: [TogglePanelComponent, MyMessageComponent,FormsModule,CommonModule],
  templateUrl: './gen-crud-table.component.html',
  styleUrl: './gen-crud-table.component.css'
})
